...
export const metadata: Metadata = publicMetadata({
  ...
  description: 'Learn what Webvidence collects, how business and website data is processed, which service providers are used, and what choices account holders have.',
  path: '/privacy',
  keywords: ['Webvidence privacy', 'privacy policy', 'Webvidence legal'],
});
  ...
  const schema = [
    {
      ...
      name: 'Privacy Policy',
      description: 'Privacy practices for Webvidence accounts, searches, audits, billing, and usage data.',
  ...
  return (
    <>
      ...
      <main className="legal-page shell">
        ...
        <section><h2>5. Feedback and testimonial permission</h2><p>If you submit the feedback form, Webvidence stores the answers you provide, including workflow details, outreach outcomes, an optional written message, and the public-use permission you select. Feedback is used privately for product improvement by default. Quotes, outcome details, identity, or combined statistics are used publicly only within the permission recorded with that submission. You may contact Webvidence to withdraw permission for future marketing use.</p></section>
        <section><h2>6. How information is used</h2><p>Information is used to create and secure accounts, run searches and analyses, save work, generate requested drafts, enforce plan limits, process subscriptions, provide support, detect abuse, monitor costs and performance, comply with law, and improve the service.</p></section>
        <section><h2>7. Service providers</h2><p>Webvidence uses service providers that may process information on our behalf, including Supabase for authentication and database services, Google Maps Platform and PageSpeed Insights for business and website information, OpenAI for requested outreach generation when enabled, Stripe for billing, Resend for feedback-notification email, and Vercel for hosting, analytics, and performance monitoring. Their handling of information is governed by their own terms and privacy policies.</p></section>
        <section><h2>8. Sharing</h2><p>We do not sell personal information. Information may be shared with service providers needed to operate Webvidence, professional advisers, authorities when legally required, or a successor in connection with a merger, financing, acquisition, or sale of the service. Public business information may be shown back to authorized users who requested the search.</p></section>
        <section><h2>9. Retention</h2><p>Account and workspace data is retained while the account is active and for a reasonable period afterward for recovery, security, billing, dispute resolution, and legal compliance. Public business records and audits may be refreshed, archived, or deleted. Provider and security logs may be retained for shorter or longer periods depending on operational and legal needs.</p></section>
        <section><h2>10. Security</h2><p>Webvidence uses access controls, server-side authorization, database row-level security, encrypted connections, rate limits, signed billing webhooks, and private-network protections. No system can guarantee absolute security, so users should use a unique password and protect account access.</p></section>
        <section><h2>11. Your choices</h2><p>You can update workspace information, archive or delete eligible saved leads, cancel a paid plan, and request account-data access or deletion. Some records may be retained when required for billing, fraud prevention, security, legal obligations, or legitimate dispute resolution.</p></section>
        <section><h2>12. Cookies and authentication</h2><p>Webvidence uses essential cookies for authentication and session security. Vercel analytics and performance tools may collect limited usage information depending on deployment settings. Browser controls can limit nonessential storage, but blocking required authentication cookies may prevent the application from working.</p></section>
        <section><h2>13. Children</h2><p>Webvidence is a business tool and is not directed to children under 13. We do not knowingly collect personal information from children under 13.</p></section>
        <section><h2>14. Changes</h2><p>We may update this policy as providers, features, or legal requirements change. The effective date will be updated when changes are posted.</p></section>
        <section><h2>15. Contact</h2><p>Privacy questions or account-data requests can be sent to <a href={`mailto:${supportEmail}`}>{supportEmail}</a>.</p></section>
      </main>
      <MarketingFooter />
    </>
  );

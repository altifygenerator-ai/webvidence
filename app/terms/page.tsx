  ...
  return (
    <>
      ...
      <main className="legal-page shell">
        ...
        <section><h2>8. Trials, subscriptions, cancellation, and refunds</h2><p>Eligible accounts may receive one 7-day Freelancer trial when payment information is collected through Stripe. The trial converts to the stated monthly Freelancer price unless canceled before it ends. Paid plans renew automatically until canceled. Prices, trial terms, and billing periods are shown before checkout. You can manage or cancel a subscription through the billing portal. Cancellation normally takes effect at the end of the current trial or paid period. Except where required by law or expressly stated otherwise, charges already paid are nonrefundable.</p></section>

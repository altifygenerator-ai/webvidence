...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    // A corrected domain invalidates every previously discovered contact path.
    await db.from('lead_contact_paths').delete().eq('lead_id', lead.id).eq('workspace_id', user.workspaceId);

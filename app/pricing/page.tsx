    ...
    mainEntity: {
      ...
      offers: CUSTOMER_PLAN_ORDER.map((id) => {
        ...
        return {
          ...
          description: `${plan.searches} searches, ${plan.audits} analyzed prospects, ${plan.messages} outreach drafts, ${plan.campaigns} saved markets, and ${plan.saved} saved leads per month.${id === 'freelancer' ? ' New eligible accounts can start with a 7-day card-required trial.' : ''}`,
        };
      }),
    },
  };
            ...
            return (
              <div className={`price ${id === 'freelancer' ? 'featured' : ''}`} key={id}>
                ...
                <ul>
                  ...
                  <li>Conversation-first manual outreach</li>
                  <li className="usage-limit-label">Usage limits</li>
                  <li>{plan.searches} local searches / month</li>
                  <li>{plan.audits} analyzed prospects</li>
                  <li>{plan.messages} outreach drafts</li>
                  <li>{plan.campaigns} saved markets</li>

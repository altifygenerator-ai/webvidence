...
export const metadata: Metadata = privateMetadata('Create account', 'Create a Webvidence account.', '/signup');
  ...
  return (
    <>
      ...
      <form className="auth form" action={signup}>
        ...
        <h2>{intendedPlan ? `Create an account for ${PLANS[intendedPlan].name}` : 'Start your first prospecting session'}</h2>
        ...
        <small className="muted">No card required. Start with a real prospecting session, keep one watched market active, and use the included searches and analyses to see whether the workflow fits you.</small>
